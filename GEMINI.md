...
- Cron-generated gear-review drafts must not put rental/demo prices or dollar amounts in the title or excerpt, must not use em dashes in public copy, must contain at least 2000 body words after stripping HTML tags, and must store a selected gear image URL for the blog thumbnail instead of a small Google `thumbnailLink`.
